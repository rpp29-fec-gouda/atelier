import ImageNavigatorModel from '../../../../../client/src/components/overview/ImageNavigatorModel.js';
...
describe('<ImageNavigatorModel /> thumbnail', () => {
  ...
  it('should initialize expected properties:', function () {
    ...
    let model = new ImageNavigatorModel(props);
    ...
    model = new ImageNavigatorModel(props);

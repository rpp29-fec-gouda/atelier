...
const ImageGalleryModel_js_1 = __importDefault(require("../../../../../client/src/components/overview/ImageGalleryModel.js"));
describe('<ImageGalleryModel />', () => {
    ...
    it('should initialize expected properties:', function () {
        ...
        const model = new ImageGalleryModel_js_1.default(props, selectedPhotoIndex);
    ...
    it('getViewId should return collapsed if not expanded:', function () {
        let props = {};
        const selectedPhotoIndex = 2;
        let model = new ImageGalleryModel_js_1.default(props, selectedPhotoIndex);
        ...
        model = new ImageGalleryModel_js_1.default(props, selectedPhotoIndex);
        expect(model.getViewId()).toEqual('image-gallery-collapsed-view');
    });

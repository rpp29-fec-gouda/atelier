...
const ImageNavigatorModel_1 = __importDefault(require("./ImageNavigatorModel"));
require("./imageNavigator.css");
class ImageNavigator extends react_1.default.Component {
    constructor(props = {
        thumbnails,
        useIcons,
        length,
        ...
        this.model = new ImageNavigatorModel_1.default(this.injectProperties(true));
    ...
    render() {
        ...
        this.model = new ImageNavigatorModel_1.default(this.injectProperties());
        ...
        return (<div class="image-navigator-component">
            ...
            <div class="navigator-align">
              <div class="image-navigator-control image-navigator-decrement">
                <svg viewBox="0,0,1000,837">
                  <path d="M71.9816+837.371L500.008+309.729L928.018+837.371L1000+778.965L500.008+162.629L0+778.965L71.9816+837.371Z"/>
                </svg>
              </div>
            </div>
          </div>}
        {items.map(item => (<div key={itemKey++} class={itemClass} data-image-id={item.id} onClick={this.handleClick}>
              {useCase.thumbnails &&
              ...
              {useCase.icons &&
                    <svg class={item.id === this.props.selectedId ? itemChildClassSelected : itemChildClass} viewBox="0,0,149,132">
        ...
        {model.lastIndexNotVisible(endIndex) &&
            ...
            <div class="navigator-align">
              <div class="image-navigator-control image-navigator-increment">
                <svg viewBox="0,0,1000,837">
                  <path d="M71.9816-0.371452L500.008+527.271L928.018-0.371452L1000+58.0347L500.008+674.371L0+58.0347L71.9816-0.371452Z"/>
                </svg>
              </div>
            </div>
          </div>}
...
exports.default = ImageNavigator;

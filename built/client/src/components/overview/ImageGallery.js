...
const ScrollingArrows_1 = __importDefault(require("../shared/ScrollingArrows"));
const ImageNavigator_1 = __importDefault(require("./ImageNavigator"));
const ImageGalleryModel_js_1 = __importDefault(require("./ImageGalleryModel.js"));
const ZoomedImageController_js_1 = __importDefault(require("./ZoomedImageController.js"));
...
class ImageGallery extends react_1.default.Component {
    constructor(props) {
        ...
        this.model = null;
        this.controller = new ZoomedImageController_js_1.default(this.containerId, this.imgId);
        this.state = {
    ...
    render() {
        ...
        this.model = new ImageGalleryModel_js_1.default({
            photos: (_a = this.props) === null || _a === void 0 ? void 0 : _a.photos,
            isExpanded: (_b = this.props) === null || _b === void 0 ? void 0 : _b.isExpanded,
            isZoomed: (_c = this.props) === null || _c === void 0 ? void 0 : _c.isZoomed
        }, currentIndex);
        const model = this.model;
        const thumbnails = model.getPhotoThumbnailUrls();
        console.log('ImageGallery: photos', (_d = this.props) === null || _d === void 0 ? void 0 : _d.photos);
        ...
        return (<div id="po-image-gallery" {...attributes}>
        <div id={viewId}>
          <div class="row">
            {!model.isZoomed &&
                <POClickTracker_1.default eventName="clickTracker" moduleName="Product Overview">
                <ImageNavigator_1.default onClick={this.updateIndex} thumbnails={thumbnails} selectedId={currentIndex} length={thumbnails.length} useIcons={model.isExpanded}/>
          ...
          <POClickTracker_1.default eventName="clickTracker" moduleName="Product Overview">
            <div id={this.containerId} onClick={handleImageClick}>
              ...
              {console.log(photoUrl)}
               <Image_1.default imageType="banner" img={{
                id: this.imgId,
                src: photoUrl,

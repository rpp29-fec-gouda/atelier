...
const ProductBreakdown = (props) => {
    ...
    return characteristics ? (<div className='rr-product-breakdown'>
      <h2 for='rr-bar-chart'>By Characteristics</h2>
      {Object.entries(chart.Characteristics).map((characteristic, i) => (<div key={i}>
          <br></br>
          <div>
...
exports.default = ProductBreakdown;

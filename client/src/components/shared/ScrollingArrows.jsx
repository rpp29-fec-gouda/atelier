...
class ScrollingArrows extends React.Component {
  constructor(props) {
    ...
    this.decrementClass = 'arrow decrement';
    this.decrementArrowClass = props.stem ? 'decrement-stem' : 'decrement-no-stem';
    this.decrementClass += ` ${this.decrementArrowClass}`;

    this.incrementClass = 'arrow increment';
    this.incrementArrowClass = props.stem ? 'increment-stem' : 'increment-no-stem';
    ...
    this.svgs = {
      noStem: {
        ...
        'decrement': 'M837.371+928.018L309.729+499.992L837.371+71.9816L778.965+0L162.629+499.992L778.965+1000L837.371+928.018Z',
        'increment': 'M-0.371452+928.018L527.271+499.992L-0.371452+71.9816L58.0347+0L674.371+499.992L58.0347+1000L-0.371452+928.018Z',
      },
      stem: {
        'viewBox': '0,0,159,159',
        'decrement': 'M159.523+65.2232L59.7936+65.2232L102.39+22.628L79.7608+0L0+79.7616L79.7608+159.523L102.39+136.895L59.7936+94.3008L159.523+94.3008L159.523+65.2232Z',
        'increment': 'M-0.523205+93.7768L99.2064+93.7768L56.6104+136.372L79.2392+159L159+79.2384L79.2392-0.523205L56.6104+22.1048L99.2064+64.6992L-0.523205+64.6992L-0.523205+93.7768Z',
      }};
  }
      ...
      <div class="scrolling-arrows">
        {
          ...
          <div class={this.decrementClass} onClick={this.incrementIndexDown}>
            <svg viewBox={this.getSvgData('viewBox')}>
              <path d={this.getSvgData('decrement')} />
            </svg>
          </div>
        }
        {
          ...
          <div class={this.incrementClass} onClick={this.incrementIndexUp}>
            <svg viewBox={this.getSvgData('viewBox')}>
              <path d={this.getSvgData('increment')} />
            </svg>
          </div>
        }
      </div>

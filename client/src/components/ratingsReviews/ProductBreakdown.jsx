    ...
    <div id='rr-product-breakdown'>
      {Object.entries(chart.Characteristics).map((characteristic, i) => (
        <div key={i}>{characteristic[0]}
          <br></br>
          <div>
            <input id='rr-bar-chart' className='rr-bar-chart' type="range" min="1" max="5" list="tickmarks" step='any' value={characteristic[1].value.slice(0, 4)} readonly></input>
            <datalist id="rr-breakdown-tickmarks" className="rr-breakdown-tickmarks">
              ...
              <option id='rr-breakdown-option' className='rr-breakdown-option'value="3" id={characteristic[0]}>{chart[characteristic[0]].third}</option>
